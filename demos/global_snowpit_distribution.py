...
for file in caaml_files:
    ...
    try:
        ...
        if pit.coreInfo.location.latitude is not None and pit.coreInfo.location.longitude is not None:
...
print("Map has been created and saved as 'demos/snowpit_distribution_by_country_2019_2020.html'")
